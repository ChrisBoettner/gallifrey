# DESCRIPTION: Running gallifrey on Plato solar-like lightcurve, 20 rounds at max_depth 0
...
save_path = pathlib.Path(__file__).parent.parent / "model_checkpoints" / "psls_shallow"
...
training_set = full_lightcurve[mask & ~transit_mask]
