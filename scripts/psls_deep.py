# DESCRIPTION: Running gallifrey on Plato solar-like lightcurve, 20 rounds at max_depth 2
...
save_path = pathlib.Path(__file__).parent.parent / "model_checkpoints" / "psls_deep"
